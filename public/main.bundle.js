...
var NewProblemComponent = (function () {
    ...
    NewProblemComponent = __decorate([
        ...
        __param(0, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["z" /* Inject */])("data")),
...
var ProblemDetailComponent = (function () {
    ...
    ProblemDetailComponent = __decorate([
        ...
        __param(1, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["z" /* Inject */])("data")),
...
module.exports = "<div class=\"container\">\n  <app-new-problem></app-new-problem>\n  <div class=\"list-group\">\n    <a class=\"list-group-item\" *ngFor=\"let problem of problems\" [routerLink]=\"['/problems', problem.id]\">\n      <span class=\"{{'pull-left label difficulty diff-' + problem.difficulty.toLowerCase()  }}\">{{problem.difficulty.toLocaleLowerCase()}}</span>\n      <strong class=\"title\">{{problem.id}}. {{ problem.name}}</strong>\n    </a>\n  </div>\n</div>\n"
...
var DataService = (function () {
    ...
    DataService.prototype.addProblem = function (problem) {
        var _this = this;
        this.http.post('/api/v1/problems', problem, { headers: new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["c" /* HttpHeaders */]({ 'Content-Type': 'application/json' }) })
            .toPromise()
            .then(function (res) {
            _this.getProblems();
        })
